        ...
        <section class="bg-white dark:bg-gray-900">
            @forelse(auth()->user()->notifications as $notification)
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                    ...
                    @empty
                        <p class="bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-green-400 mb-2">Vous n'avez pas de notifications.</p>
                    </div>
                </div>
            @endforelse
        </section>

    ...
    <div class="container mx-auto fade-in">
        <div class=" container-fluid">
            ...
            <div class="row bg-white shadow rounded-lg p-4 mt-4 flex items-center">
                ...
                <div
                    class="col bg-transparent  bg-green-500 text-white shadow rounded-lg m-1 rounded-10 p-2">
                ...
                <div
                    class="col bg-transparent  bg-red-500 text-white shadow rounded-lg m-1 rounded-10 p-2">
                    <div class="flex items-center">

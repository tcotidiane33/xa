<div class="left-side-bar">
    <div class="brand-logo">
        <a href="#">
            <img src="backoffice/vendors/images/deskapp-logo.svg" alt="" class="dark-logo" />
            <img
                src="backoffice/vendors/images/deskapp-logo-white.svg"
                alt=""
                class="light-logo"
            />
        </a>
        ...
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="index.html">Directeurs</a></li>
                        <li><a href="index2.html">Respondables</a></li>
                        <li><a href="index3.html">Gestionnaires</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="backoffice/video-player.html">Video Player</a></li>
                ...
                <li>
                    <a href="backoffice/sitemap.html" class="dropdown-toggle no-arrow">
                ...
                <li>
                    ...
                    >
                        ...
                        <span class="mtext"
                            >Landing Page
                            <img src="backoffice/vendors/images/coming-soon.png" alt="" width="25"
                        /></span>
                    </a>
                </li>
            </ul>

        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $material->type }}</td>
                    <td>
                        <a href="{{ route('materials.show', [$client, $material]) }}" class="btn btn-info btn-sm">Voir</a>
                        <a href="{{ route('materials.edit', [$client, $material]) }}" class="btn btn-warning btn-sm">Modifier</a>

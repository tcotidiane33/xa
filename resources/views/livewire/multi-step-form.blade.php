        ...
        <form wire:submit.prevent="submitForm">
            ...
            @if ($currentStep == 2)
                <div class="form-step">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="contact_compta_nom" wire:model="contact_compta_nom">
                        @error('contact_compta_nom') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="contact_compta_prenom">Prénom du contact comptabilité</label>
                        <input type="text" class="form-control" id="contact_compta_prenom" wire:model="contact_compta_prenom">
                        @error('contact_compta_prenom') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="contact_compta_telephone">Téléphone du contact comptabilité</label>
                        <input type="text" class="form-control" id="contact_compta_telephone" wire:model="contact_compta_telephone">
                        @error('contact_compta_telephone') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="contact_compta_email">Email du contact comptabilité</label>
                        <input type="email" class="form-control" id="contact_compta_email" wire:model="contact_compta_email">
                        @error('contact_compta_email') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
            @endif
            ...
            @if ($currentStep == 4)
                <div class="form-step">
                    ...
                    <div class="form-group">
                        <label for="is_cabinet">Est-ce un cabinet ?</label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="portfolio_cabinet_id" wire:model="portfolio_cabinet_id">
                            ...
                            @foreach ($clients as $portfolioClient)
                                <option value="{{ $portfolioClient->id }}">{{ $portfolioClient->name }}</option>
                            @endforeach
                        </select>
            ...
            <div class="form-navigation">
                @if ($currentStep > 1)
                    <button type="button" class="btn btn-secondary" wire:click="decreaseStep()">Précédent</button>
                @endif
                @if ($currentStep < 4)
                    <button type="button" class="btn btn-primary" wire:click="increaseStep()">Suivant</button>
                @else

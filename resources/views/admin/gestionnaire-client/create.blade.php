...
<div class="main-content">
    ...
    <div class="container">
        ...
        <form action="{{ route('admin.gestionnaire-client.store') }}" method="POST" enctype="multipart/form-data" id="gestionnaireClientForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <button type="button" id="add-gestionnaire" class="mt-1 text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Ajouter Gestionnaire</button>
            </div>
...
$(document).ready(function() {
    ...
    $('#gestionnaireClientForm').submit(function(e) {
        ...
        var gestionnairesSecondaires = $('input[name="gestionnaires_secondaires[]"]').map(function() {
            return $(this).val();
        }).get();

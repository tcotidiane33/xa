<form action="{{ route('admin.gestionnaire-client.index') }}" method="GET" class="mb-6">
    <div class="flex flex-wrap -mx-3 mb-2">
        <div class="col md:w-1/4 px-3 mb-6 md:mb-0">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="client_id">
                Client
            </label>
            <select name="client_id" class=" block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
        ...
        <div class="col md:w-1/4 px-3 mb-6 md:mb-0 flex items-end">
